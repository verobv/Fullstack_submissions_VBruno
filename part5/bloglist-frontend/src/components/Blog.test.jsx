...
test('renders blog information to null users but no buttons', () => {
  ...
  render(
    <MemoryRouter>
      <BlogView blogs={[blog]} user={null} handleLike={() => {}} handleRemove={() => {}} />
    </MemoryRouter>
  )
...
test('Authenticated non-owner users are shown only the like button', async () => {
  ...
  render(
    <MemoryRouter>
      <BlogView blogs={[blog]} user={user} handleLike={() => {}} handleRemove={() => {}} />
    </MemoryRouter>
  )
...
test('if like button is clicked twice, the event handler is called twice', async () => {
  ...
  render(
    <MemoryRouter>
      <BlogView blogs={[blog]} user={user} handleLike={mockHandler} handleRemove={() => {}} />
    </MemoryRouter>
  )
